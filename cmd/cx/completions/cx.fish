...
complete -c cx -n '__fish_use_subcommand' -a completion -d 'Print shell completions'
...
complete -c cx -n '__fish_seen_subcommand_from completion' -a 'bash zsh fish' -d 'Shell'
